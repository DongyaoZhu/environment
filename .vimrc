...
set tabstop=4     " 4 is the default spacing for tabs
set shiftwidth=4  " 4 is the default spacing for tabs
...
" Backups.
set nobackup        " prior version of the file is saved prefixed with ~
set showcmd
